...
var Router = require('./router')
  , Site = require('./site')
  , SiteSection = require('./sitesection')
...
Kerouac.prototype._bind = function(site, cb) {
  cb = cb || function() {};
  
  var self = this
    , blocks = this._blocks;
    
  var sect = new SiteSection(self.path, site);
...
Kerouac.prototype.generate = function(cb) {
  ...
  this._bind(this.site, function(err) {
    if (err) { return cb(err); }
