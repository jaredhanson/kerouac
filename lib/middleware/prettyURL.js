 ...
 * Pages are then requested with URLs of the form _http://www.example.com/slug/_,
 * rather than _http://www.example.com/slug.html_.
 *
 * This middleware also sets `page.url` to the pretty path that should be used
 * when requesting the page via the World Wide Web (as opposed to page.path,
 * which was used to request the page from local file system and includes a file
 * extension).  Templates can use this property when linking to pages with pretty
 * URLs.
 *
 * @example
