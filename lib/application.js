...
app.defaultConfiguration = function defaultConfiguration() {
  ...
  this.markup('md', require('./markup/md/html').render, {
    gfm: true,
    pedantic: false,
    sanitize: false,
    langPrefix: '',
  ...
  this.markup('md', 'txt', require('./markup/md/txt'), {
...
app.markup = function markup(ext, oext, fn, options) {
...
app.convert = function(str, type, otype, options) {
  ...
  return converter.convert(str, opts);
}
