...
app.use = function(fn) {
  ...
  fns.forEach(function(fn) {
    ...
    if (!fn || !fn.handle || !fn.set) {
      ...
      if (fn.driver) {
        this._drivers.push({ driver: fn.driver , site: fn, mountpath: path });
      }
...
// TODO: Clean up driver mountpath
function bindSite(site, pool, mountpath) {
  ...
  return function(p) {
    ...
    var path = upath.join(mountpath || site.mountpath || '', p)    
      , parent = site.parent;
    while (parent) {
